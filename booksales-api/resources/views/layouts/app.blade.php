...
<head>
  ...
  <title>@yield('title', 'BookSales API') — BookSales</title>
  ...
  <style>
    ...
    .topbar a { color: #fff; text-decoration: none; font-weight: 700; font-size: 1.2rem; }
    .topbar nav a {
    ...
    footer { text-align: center; padding: 2rem 0; color: #9ca3af; font-size: .82rem; }
  </style>
</head>
<body>
